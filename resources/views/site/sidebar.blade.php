            ...
            <ul class="list-item">
                <li class="clearfix">
                    ...
                    <div class="info fl-right">
                        <a href="?page=detail_product" title="" class="product-name">Áo</a>
                        <div class="price">
                ...
                <li class="clearfix">
                    ...
                    <div class="info fl-right">
                        <a href="?page=detail_product" title="" class="product-name">Quần</a>
                        <div class="price">
                ...
                <li class="clearfix">
                    ...
                    <div class="info fl-right">
                        <a href="?page=detail_product" title="" class="product-name">f</a>
                        <div class="price">
                            <span class="new">15.190.000đ</span>
                            <span class="old">17.190.000đ</span>
                        </div>
                ...
                <li class="clearfix">
                    ...
                    <div class="info fl-right">
                        <a href="?page=detail_product" title="" class="product-name">I</a>
                        <div class="price">
                            <span class="new">15.190.000đ</span>
                            <span class="old">17.190.000đ</span>
                        </div>
