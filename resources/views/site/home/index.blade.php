        ...
        <div class="container">
            ...
            <div class="row">
                                                                ...
                                                                <div class="actions">
                                                                    <div class="add_cart">
                                                                        <button data="{{ $row->id }}" link="{{ route('site.cart.add') }}" class="button btn-cart" type="button">
                                                                            <span><i class="fa fa-shopping-cart"></i> {{ __('Add to Cart') }} 
                                                                            </span>
                                                                        </button>
                                                                    </div>
                                                                </div>
                ...
                <div class="top-sidebar col-left sidebar col-sm-4 col-xs-12 col-sm-pull-8 col-md-3 col-md-pull-9">
                    ...
                    <div class="sidebar-banner"><img src="{{ asset('source/site/version4/images/top-banner.jpg') }}" alt="New Arrivals"></div>
                    @if($product_view)
